<template>
  <footer
    class="bg-gradient-to-r from-lime-900 to-sky-700 px-4 sm:px-6 pt-12 pb-6 font-[sans-serif]"
  >
    <div
      class="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8"
    >
      <div class="space-y-4">
        ...
        <ul class="space-y-2.5">
          <li>
            <a
              ...
              class="text-[13px] text-gray-400 hover:text-white"
              >Graphic Design Tools</a
            >
          </li>
          <li>
            <a
    ...
    <div class="max-w-screen-xl mx-auto text-center">
      <p class="text-gray-400 text-[13px]">
        Long Nguyen Copyright © 2024. All rights reserved.
      </p>
    </div>
  </footer>
</template>
